...
export default function Sidebar() {
  return (
    <aside className="fixed left-0 top-16 z-40 hidden h-[calc(100vh-64px)] w-64 border-r border-white/10 bg-[#102033]/70 px-4 py-6 backdrop-blur-2xl md:block">
      <div className="mb-8 flex items-center gap-3 rounded-lg border border-emerald-300/20 bg-emerald-300/10 px-4 py-3">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold transition ${
                isActive
                  ? 'bg-white/10 text-teal border border-white/10'
                  : 'text-muted hover:bg-white/10 hover:text-body border border-transparent'
              }`
            }
          >
